...
function Register({ error, setError, setRegister }) {
  ...
  return (
    <div className='w-full h-[85vh]  flex justify-center items-center p-2 md:p-10 flex-col relative'>
      ...
      <div  style={{ boxShadow: "0px 0px 10px rgba(0, 0, 0, 0.5)" }} className="w-full md:w-[50%] min-h-[40vh] p-10 bg-[#e6e6e6] rounded-2xl relative flex justify-center items-center flex-col">
