...
function Page() {
  ...
  return (
    <div className='overflow-hidden'>
      <img src="https://images.squarespace-cdn.com/content/v1/61ca8648a4e8bf04995cf3d7/9c0bc974-8659-4702-a76a-49cb4d5c68ff/Gradient+2.png" className='hidden md:flex absolute top-0 w-full h-full object-cover overflow-hidden' alt="" />
      <img src="https://cfcdn.apowersoft.info/astro/picwish/_astro/hero-background@750w.d5552c26.jpeg" className='md:hidden flex absolute top-0 w-full h-full object-cover overflow-hidden' alt="" />
